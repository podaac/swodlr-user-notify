...
const sesSenderArn = utils.getParameter('ses_sender_arn');
const sesConfigSetName = utils.getParameter('ses_config_set_name');
    ...
    for (const email of emails) {
      try {
        await ses.sendEmail({
          ...
          FromEmailAddressIdentityArn: sesSenderArn,
